...
| [`monocloud-auth-aspnetcore`](plugins/monocloud/skills/monocloud-auth-aspnetcore/SKILL.md)     | JWT / introspection access-token validation, scope + group authorization for ASP.NET Core APIs        | `MonoCloud.Authentication.Api`    |
